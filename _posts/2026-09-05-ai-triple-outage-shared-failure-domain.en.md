...
permalink: /en/ai-triple-outage-shared-failure-domain/
image: /assets/images/ai-triple-outage-shared-failure-domain-cover.png
image_alt: "SpaceXAI official post acknowledging Memphis compute center outage and apologizing to impacted compute partners"
author: "Wisely Chen"
...
>
> **Read the Chinese original:** [Claude 先掛、Grok 跟著、ChatGPT 晚一小時：三家 AI 大當機，真正被推翻的是那條「排除項」](https://ai-coding.wiselychen.com/ai-triple-outage-shared-failure-domain/)
>
